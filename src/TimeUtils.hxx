...
inline auto operator<<(std::ostream &out, const utils::TimeStamp &t) noexcept -> std::ostream &
{
  // As per this link:
...
inline auto operator>>(std::istream &in, utils::TimeStamp &t) noexcept -> std::istream &
{
